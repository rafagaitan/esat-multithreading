MACRO(CONFIGURE_DEFAULTS)
    ...
    ELSE()
        SET(EXTRA_CXX_FLAGS " -pthread -W -Wall -Wextra -Wparentheses -Wno-long-long -Wno-import -pedantic -Wreturn-type -Wmissing-braces -Wunknown-pragmas -Wunused -Weffc++ -Werror")
        IF(UNIX)
            IF(APPLE)
            ...
            ELSE()
                ...
                ELSE()
                    SET(EXTRA_CXX_FLAGS "${EXTRA_CXX_FLAGS} -std=c++0x -Wl,--no-as-needed")
                ENDIF()
            ENDIF()
        ENDIF()
    ENDIF()
...
MACRO(SETUP_TESTS TEST_FILES)
	...
	ENDFOREACH()
	add_dependencies(test ${TESTS_TO_PASS})
ENDMACRO(SETUP_TESTS)

MACRO(SETUP_RESOURCES TARGET_NAME COMP)
    SET(install_dest_dir share/${COMP}/${TARGET_NAME})
    SET(install_script_dir ${BIN_PATH})
    IF(APPLE)
        IF(IS_APPLICATION)
            SET(install_dest_dir ${TARGET_NAME}.app/Contents/Resources)
    ...
    IF(SCRIPT_FILES)
        INSTALL(PROGRAMS ${SCRIPT_FILES}
                DESTINATION ${install_script_dir} COMPONENT ${COMP}
