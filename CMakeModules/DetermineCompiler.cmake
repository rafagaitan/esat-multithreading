# - If Visual Studio is being used, this script sets the variable MF_COMPILER
...
IF(MSVC60)
    SET(MF_COMPILER "vc60")
ELSEIF(MSVC70)
    SET(MF_COMPILER "vc70")
ELSEIF(MSVC71)
    SET(MF_COMPILER "vc71")
ELSEIF(MSVC80)
    SET(MF_COMPILER "vc80")
ELSEIF(MSVC90)
    SET(MF_COMPILER "vc90")
ENDIF()
